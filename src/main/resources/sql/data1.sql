...
INSERT INTO thumbnail_urls (property_id, cloudfront_url) VALUES
    (UNHEX(REPLACE('1111c0f7-0c97-4bd7-a200-0de1392f1df0', '-', '')), 'd168mchs3bjm5x.cloudfront.net/eba49041-0a16-43cd-8a7a-ce9251f3a77e_KakaoTalk_Photo_2024-06-13-13-17-54 002.jpeg')
ON DUPLICATE KEY UPDATE property_id = property_id;
